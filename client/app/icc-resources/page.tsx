...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ccmapractice.com/icc-resources',
    languages: {
      en: 'https://ccmapractice.com/icc-resources',
    },
  },
  openGraph: {
    title: 'ICC Resources Hub — Inspect Practice Exam Prep',
    description:
      'The best resources for ICC building inspector exam prep: B1, B2, E1, P1 & M1 certification guides, IRC/IBC code navigation, study checklists, and free practice questions.',
    url: 'https://ccmapractice.com/icc-resources',
    type: 'website',
    images: [
      {
    ...
    <>
      <BreadcrumbListJsonLd
        items={[
          ...
          { name: 'ICC Resources', url: 'https://ccmapractice.com/icc-resources' },
        ]}
      />
