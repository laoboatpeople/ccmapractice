...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ccmapractice.com/icc-certification-guide',
    languages: {
      en: 'https://ccmapractice.com/icc-certification-guide',
    },
  },
  openGraph: {
    ...
    url: 'https://ccmapractice.com/icc-certification-guide',
    type: 'article',
    images: [
      {
    ...
    <>
      ...
      <BreadcrumbListJsonLd
        items={[
          ...
          { name: 'ICC Certification Guide', url: 'https://ccmapractice.com/icc-certification-guide' },
        ]}
      />
      <FAQPageJsonLd
        questions={[
