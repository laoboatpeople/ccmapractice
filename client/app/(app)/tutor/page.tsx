  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] -m-4 md:-m-6 lg:-m-8">
      ...
      {loadingSessions ? (
        ...
        <aside className={`fixed top-0 left-0 z-50 h-full w-72 bg-[#150A12] border-r border-border transform transition-transform duration-200 ease-in-out lg:translate-x-0 lg:static lg:flex lg:flex-col ${
            ...
            <div className="p-4 border-t border-border bg-card">
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="flex-1 h-10 px-4 py-2.5 rounded-input bg-[#150A12] border border-border text-text-primary text-sm placeholder:text-text-tertiary focus:outline-none focus:ring-2 focus:ring-blue focus:ring-offset-2 focus:ring-offset-primary transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                />
                <button
                  onClick={handleSend}
        ...
        >
          ...
          >
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2.5 rounded-input bg-[#150A12] border border-border text-text-primary text-sm placeholder:text-text-tertiary focus:outline-none focus:ring-2 focus:ring-blue focus:ring-offset-2 focus:ring-offset-primary transition-colors resize-none"
            />
