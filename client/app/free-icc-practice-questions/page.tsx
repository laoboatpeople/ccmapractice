...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ccmapractice.com/free-icc-practice-questions',
    languages: {
      en: 'https://ccmapractice.com/free-icc-practice-questions',
    },
  },
  openGraph: {
    title: 'Free ICC Practice Questions — Open-Book Code Questions — Inspect Practice',
    ...
    url: 'https://ccmapractice.com/free-icc-practice-questions',
    type: 'website',
    images: [
      {
    ...
    <>
      ...
      <BreadcrumbListJsonLd
        items={[
          ...
          { name: 'Free ICC Practice Questions', url: 'https://ccmapractice.com/free-icc-practice-questions' },
        ]}
      />
