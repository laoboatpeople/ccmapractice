...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ccmapractice.com/blog/icc-study-mistakes',
    languages: {
      en: 'https://ccmapractice.com/blog/icc-study-mistakes',
    },
  },
  openGraph: {
    title: 'Top 10 Mistakes ICC Exam Candidates Make (And How to Avoid Them) — Inspect Practice',
    ...
    url: 'https://ccmapractice.com/blog/icc-study-mistakes',
    type: 'article',
    images: [
      {
    ...
    <>
      ...
      <BreadcrumbListJsonLd
        items={[
          ...
          { name: 'Top 10 Mistakes ICC Exam Candidates Make', url: 'https://ccmapractice.com/blog/icc-study-mistakes' },
        ]}
      />
