...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ccmapractice.com/blog/icc-exam-structure',
    languages: {
      en: 'https://ccmapractice.com/blog/icc-exam-structure',
    },
  },
  openGraph: {
    title: 'ICC Exam Structure: B1, B2, E1, P1 & M1 — Questions, Time & Passing Scores — Inspect Practice',
    ...
    url: 'https://ccmapractice.com/blog/icc-exam-structure',
    type: 'article',
    images: [
      {
    ...
    <>
      ...
      <BreadcrumbListJsonLd
        items={[
          ...
          { name: 'ICC Exam Structure', url: 'https://ccmapractice.com/blog/icc-exam-structure' },
        ]}
      />
