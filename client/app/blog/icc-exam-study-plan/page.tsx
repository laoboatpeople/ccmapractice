...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ccmapractice.com/blog/icc-exam-study-plan',
    languages: {
      en: 'https://ccmapractice.com/blog/icc-exam-study-plan',
    },
  },
  openGraph: {
    title: '12-Week ICC Exam Study Plan: A Step-by-Step Schedule — Inspect Practice',
    description:
      'A proven 12-week study plan for ICC certification exams (B1, B2, E1, P1, M1). Week-by-week schedule covering code navigation, practice questions, and timed simulations.',
    url: 'https://ccmapractice.com/blog/icc-exam-study-plan',
    type: 'article',
    images: [
      {
    ...
    <>
      ...
      <BreadcrumbListJsonLd
        items={[
          ...
          { name: '12-Week ICC Exam Study Plan', url: 'https://ccmapractice.com/blog/icc-exam-study-plan' },
        ]}
      />
