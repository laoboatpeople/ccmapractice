...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ccmapractice.com/blog/irc-study-guide',
    languages: {
      en: 'https://ccmapractice.com/blog/irc-study-guide',
    },
  },
  openGraph: {
    title: 'IRC Study Guide: How to Navigate the International Residential Code — Inspect Practice',
    description:
      'Master the International Residential Code (IRC) for your ICC B1 exam. Chapter-by-chapter map, section-numbering system, index strategies, and open-book lookup drills.',
    url: 'https://ccmapractice.com/blog/irc-study-guide',
    type: 'article',
    images: [
      {
    ...
    <>
      ...
      <BreadcrumbListJsonLd
        items={[
          ...
          { name: 'IRC Study Guide', url: 'https://ccmapractice.com/blog/irc-study-guide' },
        ]}
      />
