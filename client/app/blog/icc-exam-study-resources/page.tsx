...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ccmapractice.com/blog/icc-exam-study-resources',
    languages: {
      en: 'https://ccmapractice.com/blog/icc-exam-study-resources',
    },
  },
  openGraph: {
    title: 'ICC Exam Study Resources: Best Codes, Books & Tools — Inspect Practice',
    description:
      'The definitive list of ICC exam study resources: official codes (IRC, IBC, NEC, IPC, IMC), ICC training materials, practice tests, and AI-powered study tools for B1, B2, E1, P1 & M1.',
    url: 'https://ccmapractice.com/blog/icc-exam-study-resources',
    type: 'article',
    images: [
      {
    ...
    <>
      ...
      <BreadcrumbListJsonLd
        items={[
          ...
          { name: 'ICC Exam Study Resources', url: 'https://ccmapractice.com/blog/icc-exam-study-resources' },
        ]}
      />
