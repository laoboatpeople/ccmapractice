        ...
        <article className="max-w-3xl mx-auto px-6 pt-16 pb-24">
          <header className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              <span className="text-[11px] font-medium text-[#DB2777] bg-[#DB2777]/10 px-2 py-1 rounded">Exam Strategy</span>
          ...
          <div className="flex items-center gap-3 mb-8 pb-6 border-b border-white/5">
            ...
            <div>
              ...
              <p className="text-xs text-[#64748B]">NHA CCMA exam preparation specialists — helping medical assistants pass the first time</p>
            </div>
          </div>

          <div className="prose prose-invert max-w-none text-[#CBD5E1] leading-relaxed space-y-6">
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">1. Studying Without the Blueprint</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">2. Memorizing Facts Without Clinical Context</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">3. Not Knowing Your Normal Ranges Cold</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">5. Skipping the Pretest Question Strategy</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">6. Ignoring HIPAA and OSHA Scenarios</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">7. Mixing Up the Order of Draw and Tube Additives</h2>
            <p>
