...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ccmapractice.com/blog/icc-study-techniques',
    languages: {
      en: 'https://ccmapractice.com/blog/icc-study-techniques',
    },
  },
  openGraph: {
    title: 'How to Study for ICC Open-Book Exams: 10 Proven Techniques — Inspect Practice',
    description:
      'Learn 10 proven study techniques for ICC open-book exams (B1, B2, E1, P1, M1). Code navigation drills, index-first lookups, timed simulations, and active recall strategies that actually work.',
    url: 'https://ccmapractice.com/blog/icc-study-techniques',
    type: 'article',
    images: [
      {
    ...
    <>
      ...
      <BreadcrumbListJsonLd
        items={[
          ...
          { name: 'How to Study for ICC Open-Book Exams', url: 'https://ccmapractice.com/blog/icc-study-techniques' },
        ]}
      />
