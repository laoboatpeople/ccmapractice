...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ccmapractice.com/blog/ai-icc-exam-preparation',
    languages: {
      en: 'https://ccmapractice.com/blog/ai-icc-exam-preparation',
    },
  },
  openGraph: {
    title: 'How AI Is Changing ICC Exam Preparation — Inspect Practice',
    description:
      'Discover how artificial intelligence is transforming ICC exam preparation. Adaptive learning, personalized study paths, instant code-referenced explanations, and AI tutoring for B1, B2, E1, P1 & M1.',
    url: 'https://ccmapractice.com/blog/ai-icc-exam-preparation',
    type: 'article',
    images: [
      {
    ...
    <>
      ...
      <BreadcrumbListJsonLd
        items={[
          ...
          { name: 'How AI Is Changing ICC Exam Preparation', url: 'https://ccmapractice.com/blog/ai-icc-exam-preparation' },
        ]}
      />
