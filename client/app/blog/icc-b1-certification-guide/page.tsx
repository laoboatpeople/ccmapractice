...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ccmapractice.com/blog/icc-b1-certification-guide',
    languages: {
      en: 'https://ccmapractice.com/blog/icc-b1-certification-guide',
    },
  },
  openGraph: {
    title: 'How to Get Your ICC B1 Residential Building Inspector Certification — Inspect Practice',
    ...
    url: 'https://ccmapractice.com/blog/icc-b1-certification-guide',
    type: 'article',
    images: [
      {
    ...
    <>
      ...
      <BreadcrumbListJsonLd
        items={[
          ...
          { name: 'How to Get Your ICC B1 Certification', url: 'https://ccmapractice.com/blog/icc-b1-certification-guide' },
        ]}
      />
